<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-jcolor4 border-r border-jblue2 sm:translate-x-0 text-jcolor9" aria-label="Sidebar">
   <div class="h-full px-3 pb-4 overflow-y-auto bg-jcolor4">
      ...
      <div class="mb-4">
         <ul class="flex items-center w-full text-sm text-center gap-1" id="default-styled-tab" data-tabs-toggle="#default-styled-tab-content" data-tabs-active-classes="bg-[#00ADB5] text-[#EEEEEE]" data-tabs-inactive-classes="" role="tablist">
            <li class="flex-auto w-full" role="presentation">
                  <button class="inline-block p-3 w-full bg-jcolor5 text-jcolor9 rounded-md hover:text-jwhite2 hover:border hover:border-jblue1" id="profile-styled-tab" data-tabs-target="#styled-profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Profile</button>
            </li>
            <li class="flex-auto w-full" role="presentation">
                  <button class="inline-block p-3 w-full bg-jcolor5 text-jcolor9 rounded-md hover:text-jwhite2 hover:border hover:border-jblue1" id="dashboard-styled-tab" data-tabs-target="#styled-dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">Dashboard</button>
            </li>
         </ul>
      </div>
