            ...
            if (data.length > 0) {
                const rows = data.map((item, index) => `
                    <tr>
                        ...
                        <td class="text-center text-red-600">${item.bet_stake ? parseFloat(item.bet_stake).toFixed(2) : '0.00'}</td>
                        <td class="text-center text-green-500">${item.bet_potential_payout ? parseFloat(item.bet_potential_payout).toFixed(2) : '0.00'}</td>
