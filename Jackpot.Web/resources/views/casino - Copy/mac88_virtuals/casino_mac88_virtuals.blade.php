<div class="mb-4 mt-2" x-data="{ activeTab: 'mac88' }">
    <ul class="grid grid-cols-2 md:grid-cols-7 items-center  w-full text-sm text-center" role="tablist">
       <li class="flex-auto w-full" role="presentation">
             <button
                @click="activeTab = 'fungames_all'"
                :class="activeTab === 'fungames_all' 
       ...
       <li class="flex-auto w-full" role="presentation">
             <button
                @click="activeTab = 'fungames_aviator'"
                :class="activeTab === 'fungames_aviator' 
                    ? 'bg-[#03777C] text-[#EEEEEE] ' 
                    : 'border border-jcolor1 text-jcolor9 '"
       ...
       <li class="flex-auto w-full" role="presentation">
            <button
            @click="activeTab = 'fungames_crash'"
            :class="activeTab === 'fungames_crash' 
                ? 'bg-[#03777C] text-[#EEEEEE] ' 
                : 'border border-jcolor1 text-jcolor9 '"
            class="flex flex-col items-center px-3 py-6 w-full rounded-none hover:border-jblue2 hover:text-jwhite2 gap-1"
            >
        ...
        <li class="flex-auto w-full" role="presentation">
            <button
            @click="activeTab = 'fungames_slots'"
            :class="activeTab === 'fungames_slots' 
                ? 'bg-[#03777C] text-[#EEEEEE] ' 
                : 'border border-jcolor1 text-jcolor9 '"
            class="flex flex-col items-center px-3 py-6 w-full rounded-none hover:border-jblue2 hover:text-jwhite2 gap-1"
            >
        ...
        <li class="flex-auto w-full" role="presentation">
            <button
            @click="activeTab = 'fungames_cothers'"
            :class="activeTab === 'fungames_cothers' 
                ? 'bg-[#03777C] text-[#EEEEEE] ' 
                : 'border border-jcolor1 text-jcolor9 '"
            class="flex flex-col items-center px-3 py-6 w-full rounded-none hover:border-jblue2 hover:text-jwhite2 gap-1"
            >
